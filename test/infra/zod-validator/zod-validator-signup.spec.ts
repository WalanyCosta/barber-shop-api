...
import { signupSchema, ZodValidator } from '@/infra/libs/validator'
...
describe('ZodValidator - signup', () => {
  test('should return error if name is required', () => {
    ...
    expect(error).toEqual(
      new ValidationError('name is required. Please write name'),
    )
  })
  ...
  test('should return error if name is empty', () => {
    ...
    expect(error).toEqual(
      new ValidationError('name is empty. Please write name'),
    )
  })
  ...
  test('should return error if phone is required', async () => {
    ...
    expect(httpResponse).toEqual(
      new ValidationError('phone is required. Please write phone'),
    )
  })
  ...
  test('should return error if phone is empty', async () => {
    ...
    expect(error).toEqual(
      new ValidationError('phone is empty. Please write phone'),
    )
  })
})
